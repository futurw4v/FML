...
class ResourcepackPageState extends State<ResourcepackPage> {
  ...
  Future<void> _downloadToCurrentVersion(String url, String fileName) async {
    try {
      ...
      savePath = '$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}resourcepacks${Platform.pathSeparator}$fileName';
      if (!await Directory('$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}resourcepacks').exists()) {
        await Directory('$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}resourcepacks').create(recursive: true);
      }
