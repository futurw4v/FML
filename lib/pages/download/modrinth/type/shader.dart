...
class ShaderPageState extends State<ShaderPage> {
  ...
  Future<void> _downloadToCurrentVersion(String url, String fileName) async {
    try {
      ...
      savePath = '$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}shaderpacks${Platform.pathSeparator}$fileName';
      if (!await Directory('$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}shaderpacks').exists()) {
        await Directory('$path${Platform.pathSeparator}versions${Platform.pathSeparator}$game${Platform.pathSeparator}shaderpacks').create(recursive: true);
      }
